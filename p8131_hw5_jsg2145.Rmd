...
Fitting a model for zero inflation our parasites model shows that areas 2 and 3 are associated with higher intensity of parasites. On the other hand, higher length remains associated with lower intensity of parasites. So, fitting a model for zero inflation changed the association between area and intensity.
